...
// Vegetarian goes here
void Dish::setVegetarian(bool status)
{
    vegetarian_ = status;
}
...
// Spiciness goes here
//  int Dish::getSpicinessLevel() const
//  {
//     return spiciness_level_;
//  }

// void Dish::setSpicinessLevel(int spiciness)
// {
//     spiciness_level_ = spiciness;
// }
