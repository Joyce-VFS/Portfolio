 ...
 * @brief This file contains the declaration of the `StationManager` class, which inherits from a singly linked list template
 * to manage multiple kitchen stations in the virtual bistro simulation.
 *
 * The `StationManager` class handles a list of `KitchenStation` objects, providing methods to add, remove, and find stations,
 * as well as merge their contents. It leverages linked list operations for efficient station management.
 *
 * @date 11/10/2024
...
public:
    ...
    // Member Functions (STATION MANAGEMENT HERE)
    /**
   ...
   * @param station_name A string representing the station's name.
    ...
    */
    ...
    // Dish and ingrdients functions HERE
