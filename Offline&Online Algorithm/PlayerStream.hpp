...
private:
    ...
    std::vector<Player> players_; // will store players
    size_t current_idx_ = 0;      // will track current position
...
private:
     ...
     */
    // Your additional private members go here

    size_t cursor_ = 0, seed_ = 0;
    size_t expected_length_;
    size_t batch_size_;
    size_t current_batch_pos_ = 0;
